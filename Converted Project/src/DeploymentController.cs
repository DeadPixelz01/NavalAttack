...
static class DeploymentController
{
    ...
    public static void HandleDeploymentInput()
    {
        ...
        if (SwinGame.MouseClicked(MouseButton.LeftButton))
        {
            ...
            if (GameController.HumanPlayer.ReadyToDeploy &
                UtilityFunctions.IsMouseInRectangle(PLAY_BUTTON_LEFT, TOP_BUTTONS_TOP, PLAY_BUTTON_WIDTH,
                    TOP_BUTTONS_HEIGHT))
                ...
                TOP_BUTTONS_HEIGHT))
                _currentDirection = Direction.LeftRight;
            else if (UtilityFunctions.IsMouseInRectangle(RANDOM_BUTTON_LEFT, TOP_BUTTONS_TOP, RANDOM_BUTTON_WIDTH,
                TOP_BUTTONS_HEIGHT))
                GameController.HumanPlayer.RandomizeDeployment();
        }
    }
    ...
    public static void DrawDeployment()
    {
        ...
        foreach (ShipName sn in Enum.GetValues(typeof(ShipName)))
        {
            ...
            {
                if (sn == _selectedShip)
                    SwinGame.DrawBitmap(GameResources.GameImage("SelectedShip"), SHIPS_LEFT,
